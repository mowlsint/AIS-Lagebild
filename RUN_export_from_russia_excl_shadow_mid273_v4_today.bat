...
python make_daily_from_russia_excluding_shadow_mid273_v4.py --in "logs_v4\bbox_*.jsonl" --date %DATE% --tz UTC --out exports --shadowfleet watchlist_shadowfleet.csv --lookback-days 14
echo.
echo Output:
