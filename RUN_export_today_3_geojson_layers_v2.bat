...
python make_daily_3_geojson_layers_v2.py --in "logs_v4\bbox_*.jsonl" --date %DATE% --tz UTC --shadowfleet watchlist_shadowfleet.csv --outdir exports --lookback-days 14
echo.
