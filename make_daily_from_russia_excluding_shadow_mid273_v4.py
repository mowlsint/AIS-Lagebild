#!/usr/bin/env python3
r"""
make_daily_from_russia_excluding_shadow_mid273_v4.py (RESTORED)

Export ONLY ships that likely came FROM Russia (via RU port boxes),
BUT EXCLUDE:
- Shadow Fleet (match by MMSI/IMO against watchlist_shadowfleet.csv from GUR)
- "Russian flag" proxy via MMSI MID=273 (AIS does not broadcast flag; heuristic)
